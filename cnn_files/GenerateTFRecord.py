...
# Class initially designed to save created datasets
# Failed due to inability to pickle datasets because of lambda function
# Program not necessary for program execution

class GenerateTFRecord:
    # Generates a TFRecord from a directory of images
    ...
    def _convert_image(self, img_path):
        ...
        # Store shape of image for reconstruction
...
if __name__ == "__main__":
    ...
    t.convert_image_folder('data/training/', 'images.tfrecord')
